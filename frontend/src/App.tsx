...
function App() {
    ...
    // We use React.lazy for all page components to reduce the initial bundle size.
    // Suspense boundaries handle the loading states.
    return (
        <Suspense fallback={<div className="flex h-screen w-screen items-center justify-center bg-background"><Spinner size="xl" /></div>}>
            <Toaster />
            <Routes>
                <Route
                    path="/login"
