...
describe('IngredientsList', () => {
  ...
  it('renders empty state when no ingredients are present', () => {
    renderWithProviders(
      <IngredientsList
        data={[]}
    ...
    expect(
      screen.getByText('No se encontraron ingredientes. ¡Agrega uno para empezar!'),
    ).toBeInTheDocument();
  });
});
...
describe('IngredientForm', () => {
  it('submits create mutation', async () => {
    ...
    suppliersHookMock.useSuppliers.mockReturnValue({
      data: [{ id: 'c290f1ee-6c54-4b01-90e6-d701748f0859', name: 'Proveedor Uno' }],
    });
