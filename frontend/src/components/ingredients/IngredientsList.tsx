            ...
            {data.length === 0 ? (
              <TableRow>
                <TableCell colSpan={5} className="h-24 text-center text-muted-foreground">
                  No se encontraron ingredientes. ¡Agrega uno para empezar!
                </TableCell>
              </TableRow>
            ) : (
              data.map((ingredient) => (
                <TableRow key={ingredient.id}>
                  ...
                  <TableCell>{ingredient.product_families?.name || '-'}</TableCell>
                  <TableCell>{ingredient.suppliers?.name || '-'}</TableCell>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. El ingrediente será marcado como eliminado.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
